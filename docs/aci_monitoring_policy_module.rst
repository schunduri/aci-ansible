.. _aci_monitoring_policy:


aci_monitoring_policy - Direct access to the APIC API
+++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Description for monitoring policy</div>        </td></tr>
                <tr><td>host<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>IP Address or hostname of APIC resolvable by Ansible control host</div>        </td></tr>
                <tr><td>monitoring_policy<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Monitoring Policy name</div>        </td></tr>
