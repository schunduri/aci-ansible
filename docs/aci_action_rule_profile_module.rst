...
.. raw:: html
    ...
    <td></td>
        ...
        <td><div>post, get or delete</div>        </td></tr>
                <tr><td>action_rule_name<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Action Rule Profile Name</div>        </td></tr>
                <tr><td>descr<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td></td>
        <td></td>
        <td><div>Description for the action rule profile</div>        </td></tr>
