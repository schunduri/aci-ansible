...
.. raw:: html
    ...
    <td></td>
        <td></td>
        <td><div>Description of the Fiber Channel interface policy.</div></br>
    <div style="font-size: small;">aliases: descr<div>        </td></tr>
                <tr><td>fc_policy<br/><div style="font-size: small;"></div></td>
    <td>yes</td>
    <td></td>
        <td></td>
        <td><div>Name of the Fiber Channel interface policy.</div></br>
    ...
    <td></td>
        ...
        <td><div>The password to use for authentication.</div>        </td></tr>
                <tr><td>port_mode<br/><div style="font-size: small;"></div></td>
    <td>no</td>
    <td>f</td>
        <td><ul><li>f</li><li>np</li></ul></td>
        <td><div>Port Mode</div>        </td></tr>
